...
function LandingPage() {
 ...
 <>
   ...
   <div className="gap-y-2 sm:gap-y-5 flex flex-col justify-center items-center sm:flex sm:flex-col ">
      ...
      <Link href={'/signup'}  className="text-white w-[80%] text-sm sm:text-2xl text-bold hover:opacity-80 bg-green-600 px-4 py-2 rounded-lg text-center">
        Get Started
        
         </Link>
         <Link href={'/login'} className="text-black border-2 text-sm sm:text-2xl border-green-500 w-[80%] text-2xl text-bold hover:opacity-80 px-4 py-2 rounded-lg text-center">
